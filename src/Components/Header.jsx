...
//   className="sticky top-0 z-50 shadow-md transition-all duration-300"
//   style={{
//     background: 'linear-gradient(to left,rgb(192, 192, 226), #ffffff)', 
    
//   }}
// >

      
//       <div className="flex items-center px-4 py-0 ml-10 justify-between md:justify-start">
//         {/* Logo */}
//         <div className="flex items-center gap-0 text-blue-900 text-2xl font-bold">
//           <img src={img} alt="Least Action Logo" style={{ width: '60px', height: '60px' }} />
//           <span>Least Action</span>
//         </div>

//         {/* Desktop Nav */}
//         <nav className="hidden lg:flex items-center ml-[270px] gap-8 text-gray-800 font-medium">
...
//         {/* Desktop/Tablet Nav */}
//         <nav className="hidden md:flex items-center gap-6 lg:gap-8 text-gray-800 font-medium">
//           <a href="/" className="hover:text-blue-900 text-lg font-bold transition">Home</a>
//           <a href="/about" className="hover:text-blue-900 text-lg font-bold transition">About Us</a>
...
//               {isDropdownOpen && (
//                 <motion.div
//                   className="absolute bg-white shadow-xl mt-3 w-[200px] md:w-[236px] rounded-xl border border-gray-200 px-0 py-1 flex flex-col z-50"
//                   initial="hidden"
//                   animate="visible"
//                   exit="exit"
//                   variants={{
...
//         <button
//           ref={toggleButtonRef}
//           className="md:block lg:hidden text-3xl text-gray-800 z-50"
//           onClick={toggleMobileMenu}
//           aria-label="Toggle menu"
//         >
//           {isMobileMenuOpen ? '✕' : '☰'}
...
//       }}
//     >
//       <div className="flex items-center justify-between px-6 py-0 md:px-6 lg:px-10">
//         {/* Logo */}
//         <div className="flex items-center gap-2 text-blue-900 text-2xl font-bold">
//           <img src={img} alt="Least Action Logo" className="w-14 h-14" />
//           <span>Least Action</span>
...
//         {/* Desktop/Tablet Nav */}
//         <nav className="hidden md:flex items-center gap-4 lg:gap-8 text-gray-800 font-medium">
//           <a href="/" className="hover:text-blue-900 text-lg font-bold transition">Home</a>
//           <a href="/about" className="hover:text-blue-900 text-lg font-bold transition">About Us</a>
