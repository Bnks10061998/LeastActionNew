  ...
  return (
    <div className="bg-[url('../../assets/Digital Marketing/abtus-hero.svg')] bg-cover bg-center min-h-[70vh] md:min-h-screen w-full flex flex-col items-center px-4 text-center relative overflow-hidden">
      ...
      <div className='w-full md:w-[1100px] relative z-10'>
        <h2 className="text-3xl md:text-3xl font-bold mt-10 mb-6 md:m-10">Digital Marketing</h2>
        
        <p className="text-2xl md:text-[28px] text-gray-700 mb-10 md:mb-20 leading-relaxed md:leading-loose">
          Transform Clicks into Customers with Our Expert   <span className="text-sky-500 font-semibold" > Digital Marketing </span>  Strategies. 
        </p>    
        
        <p className="text-md md:text-2xl text-gray-600 mt-4 leading-relaxed md:leading-loose md:ml-10 mb-8 md:mb-10">
         At Kosuke Technologies, we create comprehensive digital marketing strategies that elevate your brand, focusing on innovation and data-driven approaches in SEO, content marketing, and social media to boost your online visibility.
        </p>
