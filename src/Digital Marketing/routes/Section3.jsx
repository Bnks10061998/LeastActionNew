...
import Lightbulb from '../../assets/Digital Marketing/Lightbulb.svg';
import Layout from '../../assets/Digital Marketing/Layout.svg';
import Bulb from '../../assets/Digital Marketing/bulb.svg';
import MonitorSmartphone from '../../assets/Digital Marketing/MonitorSmartphone.svg';
import CheckCircle from '../../assets/Digital Marketing/CheckCircle.svg';
import Rocket from '../../assets/Digital Marketing/Rocket.svg';

const steps = [
  {
    icon: Lightbulb,
    title: "Discovery & Strategy",
    description: "Assessing goals and audience to create a tailored marketing plan.",
  },
  {
    icon: Layout,
    title: "Campaign Design",
    description: "Crafting targeted messaging and creative assets for marketing initiatives.",
  },
  {
    icon: Bulb,
    title: "Promotional Execution",
    description: "Activating marketing campaigns through chosen mediums",
  },
  {
    icon: MonitorSmartphone,
    title: "Process Optimization",
    description: "Streamlining workflows and strategies to improve efficiency and effectiveness.",
  },
  {
    icon: CheckCircle,
