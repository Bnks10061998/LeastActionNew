...
//       </h2>
//       <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-10 justify-items-center">
...
//           <div
//             key={index}
//             className="group flex items-center gap-3 p-5 w-full border border-gray-400 rounded-md shadow-sm hover:shadow-md transition hover:bg-sky-500 hover:text-white"
//           >
//             {feature.icon}
//             <p className="text-xl md:text-2xl transition-colors">{feature.text}</p>
//           </div>
...
//   const features = [
//     {
//       icon: <Users className="w-5 h-5 text-black group-hover:text-white transition-colors" />,
//       text: "Creative & Motivated Teams",
//     },
//     {
//       icon: <Briefcase className="w-5 h-5 text-black group-hover:text-white transition-colors" />,
//       text: "We Align with Business Goals",
//     },
//     {
//       icon: <ShieldCheck className="w-5 h-5 text-black group-hover:text-white transition-colors" />,
//       text: "Quality & Security Adherence",
//     },
//     {
//       icon: <Lightbulb className="w-5 h-5 text-black group-hover:text-white transition-colors" />,
//       text: "Your Ideas Are Safe With Us",
//     },
//     {
//       icon: <Timer className="w-5 h-5 text-black group-hover:text-white transition-colors" />,
//       text: "Timely Solutions",
//     },
//     {
//       icon: <Clock className="w-5 h-5 text-black group-hover:text-white transition-colors" />,
//       text: "Seamless Support",
//     },
//   ];

//   return (
//     <div className="mx-4 sm:mx-8 px-4 py-10">
//       <p className="text-sky-500 text-xl sm:text-2xl mb-4">IT Support and Maintenance Service</p>
...
//           <div
//             key={index}
//             className="group flex items-center gap-3 p-4 border border-gray-300 rounded-lg shadow-sm hover:shadow-md transition hover:bg-sky-500 hover:text-white"
//           >
//             {feature.icon}
//             <p className="text-base sm:text-lg md:text-xl transition-colors">{feature.text}</p>
//           </div>
//         ))}
//       </div>
//     </div>
...
//           <div
//             key={index}
//             className="group flex items-center gap-2 px-3 py-2 w-full sm:w-[300px] border border-gray-300 rounded-md shadow-sm hover:shadow-md transition hover:bg-sky-500 hover:text-white"
//           >
//             {feature.icon}
//             <p className="text-sm sm:text-base transition-colors">{feature.text}</p>
//           </div>
//         ))}
//       </div>
//     </div>
