...
import MonitorSmartphone from '../../assets/MonitorSmartphone.svg';
...
const steps = [
  {
    ...
    description: "Setting goals and identifying target audiences through market research.",
  },
  {
    icon: Layout,
    title: "Planning & wireframe",
    description: "Outlining site structure and creating visual blueprints for user flow.",
  },
  {
    icon: Bulb,
    title: "Creative Design",
    description: "Developing visual elements and high-fidelity mockups to establish the site's aesthetics.",
  },
  {
    icon: MonitorSmartphone,
    title: "Responsive Development",
    description: "Building a site that adapts seamlessly to various devices and screen sizes.",
  },
  {
    icon: CheckCircle,
    title: "Quality Assurance",
    description: "Testing functionality and usability to ensure a seamless user experience and optimal performance.",
  },
  {
    icon: Rocket,
    title: "Launch & Optimization",
    description: "Deploying the site and continuously improving performance based on user feedback and analytics.",
  },
];
